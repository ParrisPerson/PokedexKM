...
@protocol SharedHttpClientProvider
@required
- (SharedKtor_client_coreHttpClient *)createHttpClient __attribute__((swift_name("createHttpClient()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpClientProviderImpl")))
@interface SharedHttpClientProviderImpl : SharedBase <SharedHttpClientProvider>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedKtor_client_coreHttpClient *)createHttpClient __attribute__((swift_name("createHttpClient()")));
@end
...
@interface SharedNetworkUtils : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)networkUtils __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedNetworkUtils *shared __attribute__((swift_name("shared")));
...
- (instancetype)initWithResults:(NSArray<SharedPokemonResult *> *)results __attribute__((swift_name("init(results:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonListResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonListResponse *)doCopyResults:(NSArray<SharedPokemonResult *> *)results __attribute__((swift_name("doCopy(results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedPokemonResult *> *results __attribute__((swift_name("results")));
@end
...
@interface SharedPokemonRepository : SharedBase
...
- (id<SharedKotlinx_coroutines_coreFlow>)getPokemonList __attribute__((swift_name("getPokemonList()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonResult")))
@interface SharedPokemonResult : SharedBase
- (instancetype)initWithName:(NSString *)name __attribute__((swift_name("init(name:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonResultCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonResult *)doCopyName:(NSString *)name __attribute__((swift_name("doCopy(name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonResult.Companion")))
@interface SharedPokemonResultCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonResultCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithHttpClientProvider:(id<SharedHttpClientProvider>)httpClientProvider __attribute__((swift_name("init(httpClientProvider:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<SharedKotlinx_coroutines_coreFlow> pokemonList __attribute__((swift_name("pokemonList")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FlowExtensionsKt")))
@interface SharedFlowExtensionsKt : SharedBase
+ (void)watch:(id<SharedKotlinx_coroutines_coreFlow>)receiver scope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope callback:(void (^)(id _Nullable))callback __attribute__((swift_name("watch(_:scope:callback:)")));
@end
