...
@NonNullApi
public class PokedexKMProjectDependency extends DelegatingProjectDependency {

    @Inject
    public PokedexKMProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
